...
function PythonStatements() {
  const objectives = [
    ...
    "Objective 3: Understand Lists and how to manipulate them",
    ...
    <>
      <div>
        <h1 style={{ margin: "15px" }}>
          Module 1 - Lec 4: Data Structures in Python
        </h1>
        ...
        <p>
          ...
          >
            <i
              ...
              style={{ color: "black" }}
            ></i>{" "}
            Module 1: Lec-2-Strings-CODE.ipynb
          </a>
        </p>
        <p>
          <a
          ...
          >
            <i
              ...
              style={{ color: "black" }}
            ></i>{" "}
            Module 1: Lec-3-Lists-and-Sets-CODE.ipynb
          </a>
        </p>
        <iframe
